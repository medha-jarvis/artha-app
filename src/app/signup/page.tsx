  ...
  if (done) return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="text-center max-w-sm">
        ...
        <Link href="/login" className="mt-6 inline-block text-indigo-600 text-sm font-medium">Back to Sign In</Link>
      </div>
    </div>
  )
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1">Create your account — free forever</p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" value={name} onChange={e => setName(e.target.value)}
                ...
                placeholder="Vishal Sharma" required />
            </div>
            <div>
